...
const contaminantFile = {
  [language.EN]: [
    ...
    "2016 PFAS TDS_Public CANLINE Export w acronyms 2024-04-17(Export).csv",
    "2017 PFAS TDS_Public CANLINE Export w acronyms 2024-04-17(Export).csv",
  ].map((file) => "./data/contaminant/en/" + file),
  [language.FR]: [
    "2017 PFAS TDS_FR_Public CANLINE Export w acronyms 2024-04-17(Export).csv",
    "2017 PFAS TDS_Public CANLINE Export w acronyms 2024-04-17(Export).csv",
